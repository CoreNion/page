...
<template>
  <div class="mx-auto max-w-screen-2xl">
    <div class="m-4 flex flex-col gap-3 justify-center">
      ...
      <p>
      <h2 class="text-2xl font-bold">個人情報の利用目的</h2>
      ...
      <p>
      <h3 class="text-xl font-bold">アクセス解析ツールについて</h3>
        本ウェブサイト(corenion.github.ioで提供されるコンテンツ)では、Googleによるアクセス解析ツール「Googleアナリティクス」を利用しています。このGoogleアナリティクスはトラフィックデータの収集のためにクッキー（Cookie）を使用しております。トラフィックデータは匿名で収集されており、個人を特定するものではありません。
      </p>
      </p>
      <p>
      <h2 class="text-2xl font-bold">個人情報の第三者提供</h2>
