...
<template>
  <div class="min-h-screen grid grid-rows-[auto_1fr_auto]">
    <header class="navbar bg-slate-300">
      <div class="flex-none">
        <nav class="dropdown sm:hidden">
      ...
      <ul class="max-sm:hidden menu menu-horizontal justify-end px-1">
        <li>
          <NuxtLink to="/trucker/" no-prefetch>FileTrucker</NuxtLink>
        </li>
        <li>
    ...
    <footer class="p-4 bg-black text-neutral-content grid grid-cols-[1fr_1fr]">
      <div>
      ...
      <div class="grid grid-cols-[repeat(3,auto)] justify-end items-center gap-4">
